export const en = {
    ...
    tools: {
        availableTools: {
            ...
            takeScreenshot: {
                name: "Screenshot",
                description: 'Say "Take a screenshot" to capture the current page.'
            },
            generateImage: {
                name: "Generate Image",
                description: 'Say "Generate an image based on [text prompt]" to create an image using AI.'
            },
            createImageMask: {
                name: "Generate Mask",
                description: 'Say "Generate a mask based on [text prompt]" to create a mask using AI.'
            },
            inpaintImage: {
                name: "Inpaint Image",
                description: 'Say "Inpaint the image based on [text prompt]" to modify an image using AI.'
            }
        },
        clipboard: {
